...
| `Medicine-or-Fix/fix-report.md` | Action list for every FAIL/WARN with root file, line number, faulty contract, required change, and verification command |
| `Medicine-or-Fix/` | Supporting fix notes for the current manual run |
