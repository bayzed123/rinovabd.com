...
| ৫ | Product weight ও order-source সহ custom invoice | **পূর্ণ** | Invoice API ও invoice page-এ product name, quantity, unit price, product weight in grams, package weight, delivery fee, payment method এবং order source রাখা/দেখানোর ব্যবস্থা আছে। Admin থেকে print invoice করা যায়। | Courier/provider-specific invoice branding বা PDF download enhancement ভবিষ্যতে যোগ করা যেতে পারে, তবে মূল requirement পূর্ণ। |
