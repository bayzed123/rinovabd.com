...
for (const file of ['index.html', 'styles.css', 'app.js', 'checkout.html', 'checkout.js', 'account.html', 'account.js', 'invoice.html', 'invoice.js', 'product.html', 'product.js']) await access(new URL(`./${file}`, import.meta.url));
